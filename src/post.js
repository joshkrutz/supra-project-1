export class Post {
  ...
  async loadImageLater() {
    ...
    let filterSVG = document.createElement("template");
    filterSVG.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="0" height="0" style="position:absolute; overflow:hidden">
        <defs>
    ...
    let filterSVGOnly = filterSVG.content.firstChild;
    this.container.append(banner, filterSVGOnly);
  }
